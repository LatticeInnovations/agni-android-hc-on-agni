...
interface PrescriptionApiService {
    ...
    @PUT("{endPoint}")
    suspend fun sendPrescriptionPut(@Path("endPoint", encoded = true) endPoint: String, @Body prescriptionResponses: List<PrescriptionResponse>): Response<BaseResponse<List<CreateResponse>>>
}