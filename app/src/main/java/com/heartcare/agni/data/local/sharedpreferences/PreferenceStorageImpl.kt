...
class PreferenceStorageImpl(private val sharedPreferences: SharedPreferences) : PreferenceStorage {
    ...
    override var lastSyncCampaignRiskFactorRecord by LongPreference(
        sharedPreferences,
        PREF_LAST_CAMPAIGN_RISK_FACTORS_SYNC_TIME,
        0L
    )
    ...
    override var lastSyncCampaignTobaccoCessationRecord by LongPreference(
        sharedPreferences,
        PREF_LAST_CAMPAIGN_TOBACCO_CESSATION_SYNC_TIME,
        0L
    )
    ...
    override var lastSyncNationalId by LongPreference(
        sharedPreferences,
    ...
    companion object {
        ...
        const val PREF_LAST_CAMPAIGN_RISK_FACTORS_SYNC_TIME = "pref_last_risk_campaign_factors_sync_time"
