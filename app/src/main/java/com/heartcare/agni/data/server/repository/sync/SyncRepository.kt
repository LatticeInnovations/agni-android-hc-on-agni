...
interface SyncRepository {
    ...
    suspend fun getAndInsertDiagnosisMaster(): ResponseMapper<List<DiagnosisMasterResponse>>
    suspend fun getAndInsertScreeningSiteMaster(): ResponseMapper<List<ScreeningSiteMasterResponse>>
    ...
    suspend fun getAndInsertCampaignSchedule(offset: Int): ResponseMapper<List<ScheduleResponse>>
    ...
    suspend fun getAndInsertCampaignHistoryMedicationData(offset: Int): ResponseMapper<List<HistoryMedicationResponse>>
    suspend fun getAndInsertFamilyHistoryData(offset: Int): ResponseMapper<List<FamilyHistoryResponse>>
    suspend fun getAndInsertCampaignFamilyHistoryData(offset: Int): ResponseMapper<List<FamilyHistoryResponse>>
    suspend fun getAndInsertAllergyData(offset: Int): ResponseMapper<List<AllergyResponse>>
    suspend fun getAndInsertCampaignAllergyData(offset: Int): ResponseMapper<List<AllergyResponse>>
    ...
    suspend fun getAndInsertReportTokenData(offset: Int): ResponseMapper<List<ReportTokenResponse>>
    suspend fun getAndSaveLatestNationalIdData(): ResponseMapper<List<NationalIdResponse>>
